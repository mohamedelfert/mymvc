...
<div class="main_div">
    ...
    <div class="emp_form">
        <form class="app_form" method="POST" action="" enctype="application/x-www-form-urlencoded">
            <fieldset>
                <legend>تعديل بيانات الموظف</legend>
                ...
                <table>
                    ...
                    <tr>
                        <td><input type="text" name="name" id="name" placeholder="ادخل اسم الموظف !" required="required" value="<?= $employees->name ?>"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="text" name="address" id="address" placeholder="ادخل عنوان الموظف" required="required" value="<?= $employees->address ?>"></td>
                    </tr>
                    ...
                    <tr>
                        <td><input type="submit" name="submit" value="تحديث"></td>
                    </tr>
                </table>
            </fieldset>
